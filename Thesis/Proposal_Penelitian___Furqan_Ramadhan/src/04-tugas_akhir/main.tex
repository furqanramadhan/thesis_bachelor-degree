...
\input{src/03-configuration/settings.tex}
% Daftar istilah yang mungkin perlu ditandai 
\input{src/04-tugas_akhir/istilah.tex}
\pagestyle{fancy}

% Add bibliography
\addbibresource{src/05-daftar_pustaka/daftar_pustaka.bib}
...
\addChapter{Halaman Pengesahan Proposal}
...
% \input{src/00-front_matter/halaman_pengesahan_skripsi}
% \thispagestyle{empty}   % Mematikan penomoran halaman

% % --- Surat pernyataan bebas plagiasi 
% \addChapter{Pernyataan Bebas Plagiasi}
% \input{src/00-front_matter/pernyataan_bebas_plagiasi}
% \thispagestyle{empty}   % Mematikan penomoran halaman
...
% \input{src/00-front_matter/abstract_id}
% \input{src/00-front_matter/abstract_en}
