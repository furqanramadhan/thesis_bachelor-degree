...
# Read the CSV file
df = pd.read_csv('suhu-box-plot.csv')
...
data_by_year = [df[df['Year'] == year]['TAVG'].values for year in years]
...
ax.set_ylabel('Daily Average Temperature (°C)', fontsize=12, fontweight='bold')
...
plt.tight_layout()
plt.savefig('annual_daily_temperature_boxplot.png', dpi=300, bbox_inches='tight')
plt.show()

# Print summary statistics
print("\n=== Annual Daily Average Temperature Statistics (°C) ===\n")
for year in years:
    data = df[df['Year'] == year]['TAVG']
